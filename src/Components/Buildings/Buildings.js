...
export default function Buildings({
  ...
  const defaultImg = "https://res.cloudinary.com/julesntare/image/upload/v1673265264/rsu_cst_buildings/undraw_apartment_rent_o0ut_sj75zz.png";
  ...
  useEffect(() => {
    const fetchBuildings = async () => {
      const response = await fetch(`${process.env.REACT_APP_RSU_API_URL}/building/all`);
              ...
              >
                ...
                <div className="card-body p-2">
                  ...
                  <div className="py-1 d-flex flex-column justify-content-center btn-box">
                    ...
                    <Link to={`/maps/${item.coordinates.join("&")}`}
