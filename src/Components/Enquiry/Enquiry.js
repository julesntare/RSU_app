  ...
  return (
      <div className='container-fluid  comment-section mt-5 row h-100 w-100'>
        ...
        <form onSubmit={handleEnquirySubmit} className="d-flex flex-column justify-content-center form-enquiry p-2">
          <div className="mb-3">
            <input type="text" className="form-control" id="name" aria-describedby="nameHelp" placeholder="Your name"  ref={namesRef} required />
          </div>
          <div className="mb-3">
            <input type="email" className="form-control" id="email" aria-describedby="emailHelp" placeholder="Your email"  ref={emailRef} required />
          </div>
          <div className="mb-3">
          <input type="tel"  className="form-control" id="phone" name="phone" placeholder="Your mobile No." required  ref={phoneRef} />
          </div>
