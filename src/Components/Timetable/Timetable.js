...
const Timetable = () => {
  return (
    <>
      <section className='bg-light container-fluid h-100 text-dark  w-100'>
        {/* <NavBar /> */}
        <h1 className="h1 mt-4 mb-3">Welcome To Timetable Page

        </h1>
        <span className="fw-bold text-sm mt-5 text-success">
